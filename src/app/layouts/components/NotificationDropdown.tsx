...
const TYPE_ICON: Record<string, React.ReactNode> = {
  ...
  hr_leave_status_updated:<CalendarCheck size={14} />,
  hr_attendance_exception_submitted:      <ClipboardList size={14} />,
  hr_attendance_exception_status_updated: <ClipboardList size={14} />,
...
const TYPE_ICON_BG: Record<string, string> = {
  ...
  hr_leave_status_updated:'bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400',
  hr_attendance_exception_submitted:      'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400',
  hr_attendance_exception_status_updated: 'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400',
