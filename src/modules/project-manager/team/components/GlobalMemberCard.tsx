  ...
  return (
    <div className={[
      ...
      <div className="border-t border-gray-100 dark:border-gray-700 pt-2.5 space-y-2.5">
        ...
        {/* Actions */}
        <div className="flex items-center justify-between">
          <Button variant="icon" title={isAr ? 'تبديل الحالة' : 'Toggle status'} onClick={() => onToggleActive(member.name)}>
            <Power size={14} />
          </Button>
          <Button variant="secondary" size="sm" startIcon={<Eye size={13} />} onClick={() => onView(member)}>
