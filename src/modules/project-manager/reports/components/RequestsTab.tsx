import { useProjectRequests, type FilterKey } from '../hooks/useProjectRequests';
...
export function RequestsTab({ isAr }: Props) {
  const { visible, filter, setFilter, approve, reject } = useProjectRequests(isAr);
