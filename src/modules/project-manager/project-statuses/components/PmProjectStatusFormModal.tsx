...
export function PmProjectStatusFormModal({ open, onClose, onSubmit, initial, isLoading, isAr }: Props) {
  ...
  function set<K extends keyof CreatePmProjectStatusPayload>(key: K, value: CreatePmProjectStatusPayload[K]) {
  ...
  function handleSubmit() {
    ...
    if (initial) {
      ...
      onSubmit(updateBody as CreatePmProjectStatusPayload);
      return;
    }
