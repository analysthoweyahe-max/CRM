...
// Maps the /v1/admins record into the same shape AdminEmployeeTable expects,
// so the Managers page can reuse that table as-is.
function toManagerVM(m: ApiAdminManager): AdminEmployee {
