...
export const authTranslations = {
  ar: {
    ...
    otp: {
      ...
      expiresLabel: 'ينتهي الرمز في',
      invalidCode:  'رمز التحقق غير صحيح أو منتهي الصلاحية.',
      resendFailed: 'تعذّر إعادة الإرسال. حاول مرة أخرى.',
      mailSendFailed: 'تعذّر إرسال البريد. حاول مرة أخرى بعد قليل.',
      resendTooSoon:  'انتظر قليلاً قبل طلب رمز جديد.',
  ...
  en: {
    ...
    otp: {
      ...
      mailSendFailed: 'Could not send the email. Please try again shortly.',
      resendTooSoon:  'Please wait a moment before requesting a new code.',
